...
Route::get('entreprise/{slug}','FrontOffice\EntrepriseController@show');




//route pour les offres commerciale
Route::get('entreprise/{id}/offre/commerciales/create','Entreprise\OffreCommercialeController@create');
